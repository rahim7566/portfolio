...
const categories: { title: string; items: { name: string; src: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Azure DevOps", src: "https://cdn.simpleicons.org/azuredevops" },
      { name: "IntelliJ IDEA", src: "https://cdn.simpleicons.org/intellijidea" },
      { name: "VS Code", src: "https://cdn.simpleicons.org/visualstudiocode" },
    ],
  },
  {
    title: "Databases",
    items: [
      ...
      { name: "SQL Server", src: "https://cdn.simpleicons.org/microsoftsqlserver" },
    ],
  },
  {
    title: "APIs & Testing",
